export const defaultSiteContent = {
  heroImage: 'https://images.unsplash.com/photo-1651307114090-0fa8585aa10f',
  destinations: [
    {
      name: 'Ladakh Circuit',
  ...
  office: {
    address: '8A/71G groundfloor , WEA , Channa Market , karol Bagh , New Delhi (110005)',
    email: 'brotherstravel@gmail.com',
  },
  contact: {
    whatsappNumber: '',
    phoneNumber: '',
